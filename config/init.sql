...
-- Inserir uma empresa
INSERT INTO Empresa (nome, cnpj, telefone, cep, estado, cidade, bairro, logradouro, telefone_responsavel, email_responsavel, nome_responsavel, grupo_id)
VALUES ('Empresa1', '74363470000156', '41998989898', '82315150', 'PR', 'Curitiba', 'São Braz', 'Concriz', '41999999999', 'responsavel@example.com', 'Responsável', 1);

-- Inserir duas unidades
INSERT INTO Unidade (nome, cep, estado, cidade, bairro, logradouro, empresa_id, gestor_id)
VALUES ('Unidade 1', '81170230', 'PR', 'Curitiba', 'Cidade Industrial', 'Cyro Correia Pereira','A', 1, 2),
...
VALUES ('01590575076', '98979', 'Operador 2', 'T', 2, 2, 'O');

-- Inserir uma máquina
INSERT INTO Maquina (nome, fabricante, modelo, capacidade_operacional, gestor_id, empresa_id)
VALUES ('Máquina 1', 'Fabricante 1', 'Modelo 1', 100, 2, 1),
VALUES ('Máquina 2', 'Fabricante 2', 'Modelo 2', 90, 2, 1);

-- Inserir um talhão
INSERT INTO Talhao (codigo, tamanho, status, gestor_id, empresa_id)
VALUES ('1234', '10', 'A', 2, 1);
